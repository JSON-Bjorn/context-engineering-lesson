# Context Engineering Lesson - Data Files Specifications

## Document Purpose
This document provides complete specifications for all JSON data files that power the lesson. These files contain the document corpus, evaluation questions, and reference examples.
...
```
data/
├── source_documents.json           # 10 documents about context engineering
├── evaluation_questions.json       # 10 test questions with ground truth
└── context_examples.json           # 5 reference examples of good context engineering
```

**Total Size:** ~100-150 KB (all files combined)

---

# File 1: data/source_documents.json

## Purpose
Contains the document corpus that students will use to practice context assembly strategies. Documents cover various aspects of context engineering.
  ...
  "documents": [
    {
      ...
      "tokens": 847,
      "category": "fundamentals|strategies|optimization|case_studies",
...
# File 2: data/evaluation_questions.json

## Purpose
Test questions with ground truth answers for evaluating context assembly strategies. Cover different difficulty levels and question types.
  ...
  "questions": [
    {
      ...
      "question_type": "factual|comparison|application|synthesis"
    }
  ],
  "metadata": {
    "total_questions": 10,
